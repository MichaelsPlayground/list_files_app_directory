...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Get List of Files with whole Path'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  //Declare Globaly
  String directory = '';
  // List file = new List(); not null safety
  List file = <int>[];
  ...
  void _generateDemoFiles() async {
    ...
    final f2 = '${directory.path}/file2.txt';
    new File(f2)
        .writeAsString('my string to write')
        .then((File file) {
      // you could do something here when done
